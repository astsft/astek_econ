...
int cloop_get_cal(void)
{
  ...
  if ((uint32_t)dev.cloop->cal_ch1[0].raw.i32 >= 0x1000)
  {
  ...
  if ((uint32_t)dev.cloop->cal_ch1[1].raw.i32 >= 0x1000)
  {
  ...
  if ((uint32_t)dev.cloop->cal_ch2[0].raw.i32 >= 0x1000)
  {
  ...
  if ((uint32_t)dev.cloop->cal_ch2[1].raw.i32 >= 0x1000)
  {
