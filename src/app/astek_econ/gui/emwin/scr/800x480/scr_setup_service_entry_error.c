/**
  * @file    scr_setup_service_entry_error.c
  * @brief   Screen Setup Calibrate Entry Error
...
static const GUI_WIDGET_CREATE_INFO     dialog_info[] =
{
    ...
    { TEXT_CreateIndirect,      "", GUI_ID_TEXT_ERROR,           50, 120, 700, 60, 0, 0x0, 0 },
...
init_dialog(                                            WM_HWIN         hWin )
{
    ...
    hItem   = WM_GetDialogItem( hWin, GUI_ID_TEXT_ERROR );
    TEXT_SetFont(           hItem, &GUI_FontTahoma40                        );
    TEXT_SetTextAlign(      hItem, TEXT_CF_HCENTER | TEXT_CF_VCENTER        );
    TEXT_SetBkColor(        hItem, GUI_TRANSPARENT                          );
    TEXT_SetTextColor(      hItem, GUI_RED                                  );
    TEXT_SetText(           hItem, l10n_str_get( dev.cfg.lang, L10N_STR_ID_ERROR )        );
...
/**
  ...
  */
WM_HWIN
scr_setup_service_entry_error( void )
{
