...
typedef enum
{
    ...
    GUI_ID_TEXT_DEVIATION,
    GUI_ID_TEXT_DEVIATION_LABEL,
    GUI_ID_TEXT_DIGC,
    GUI_ID_TEXT_ERROR,
    GUI_ID_TEXT_FILTER,
    ...
    GUI_ID_TEXT_SENSOR_ID,
    GUI_ID_TEXT_SENSOR_HW,
    GUI_ID_TEXT_SENSOR_UID,
    GUI_ID_TEXT_SENSOR_FW,
    GUI_ID_TEXT_VALUE,
    GUI_ID_TEXT_TRANSITION_TIME,
    GUI_ID_TEXT10,
    GUI_ID_TEXT11,
    GUI_ID_TEXT12,
    GUI_ID_TEXT13,
...
typedef enum
{
    ...
    GUI_ID_BUTTON_SLOPE,
    GUI_ID_BUTTON_STABLE_TIME,
    GUI_ID_BUTTON_TRANSITION_TIME,
    GUI_ID_BUTTON_CYCLE_TIME,
    GUI_ID_BUTTON_TIME,
    GUI_ID_BUTTON_ZERO,
    GUI_ID_BUTTON_RELAY,
