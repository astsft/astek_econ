...
{ 
        //osMutexDef( MUTEX );                                            /* Create Mutex lock */
        //osMutex         = osMutexCreate( osMutex(MUTEX) );              /* Create the Mutex used by the two threads */
        //osSemaphoreDef( SEM );                                            /* Create Semaphore lock */
...
{
        osMutexWait( xMutex , osWaitForever );
}
